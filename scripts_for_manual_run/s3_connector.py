...
class S3Connector:
    ...
    """
    AWS_S3_CREDENTIALS = cr.AWS_S3_CREDENTIALS
    ...
    def _s3_client(cls) -> boto3.client:
        ...
        s3_client = boto3.client('s3',
                                 aws_access_key_id=cls.AWS_S3_CREDENTIALS["key"],
                                 aws_secret_access_key=cls.AWS_S3_CREDENTIALS["secret"],
                                 aws_session_token=cls.AWS_S3_CREDENTIALS["token"]
                                 )
