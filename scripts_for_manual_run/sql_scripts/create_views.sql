...
JOIN rbukharev.dim_top10_molecule_properties dtmp_s
    on fms.source_chembl_id = dtmp_s.chembl_id
JOIN rbukharev.dim_top10_molecule_properties dtmp_t
    on fms.target_chembl_id = dtmp_t.chembl_id
;
--   8.a
